...
#         params = (
#         item['author'], item['title'], item['url'], item['pubday'], item['comments'], item['likes'], item['rewards'],
#         item['reads'])
...
#from patents.patents import Settings as settings
class ZreadingPipeline(object):
